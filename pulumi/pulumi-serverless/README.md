...
An example that shows how to use the [`@pulumi/aws-serverless`](https://www.npmjs.com/package/@pulumi/aws-serverless) package to easily define API Gateway and Lambda resources.
